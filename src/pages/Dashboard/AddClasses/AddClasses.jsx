...
const AddClasses = () => {
	...
	const onSubmit = data => {
		...
		.then(imgResponse => {
			...
			const newClass = {name, image: imageURL, seats: parseInt(seats), price: parseFloat(price), enrolled: parseInt(enrolled), category, status, details, instructorInfo: instructor}
