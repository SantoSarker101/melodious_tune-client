...
const NavBar = () => {
  ...
  {/* sun icon */}
  <svg
    className="swap-on h-6 w-6 md:h-8 md:w-8 lg:h-10 lg:w-10 fill-current text-orange-500 font-extrabold"
  ...
  {/* moon icon */}
  <svg
    className="swap-off h-6 w-6 md:h-8 md:w-8 lg:h-10 lg:w-10 fill-current text-pink-800"
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24">
    <path
      d="M21.64,13a1,1,0,0,0-1.05-.14,8.05,8.05,0,0,1-3.37.73A8.15,8.15,0,0,1,9.08,5.49a8.59,8.59,0,0,1,.25-2A1,1,0,0,0,8,2.36,10.14,10.14,0,1,0,22,14.05,1,1,0,0,0,21.64,13Zm-9.5,6.69A8.14,8.14,0,0,1,7.08,5.22v.27A10.15,10.15,0,0,0,17.22,15.63a9.79,9.79,0,0,0,2.1-.22A8.11,8.11,0,0,1,12.14,19.73Z" />
...

			{
				...
				<FaShoppingCart className='w-5 h-5 text-green-400'></FaShoppingCart>
				</Link>
			</div>
			}
			</div>
